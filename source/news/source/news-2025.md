...
## Knowledge Transfer and Share (KT) Sessions
 ...
 ## Public Technical Sessions 
  ...
  - Reusability Mindset Meets GitHub: Shaping Smarter Engineering Practices 
    ...
    - **Video Link:** You can find the session at the following link: [GitHub Package Management with Actions: From Repetition to Reusability](https://youtu.be/DzSvnpLSOuo?si=2yXurwVNRwr8OCIm).
